...
(define p6 #t)
;;;ANSWER:
;;;this computation gives the powers of 2, like 2^0, 2^1, 2^2, 2^3
;;;First value is 1. Then 1+1 =2 Then 2+2 =4 Then 4+4 =8 ...
